      ...
      <div className=" container py-3 phone">
        ...
        <div className="row gy-5 gx-2 ">
          <div className="col-md-3  text-center">
            <Image src={layer1} width={300} height={400} alt="phone-download" />
            <h4 className="  py-3 phoneusepra"> حمل التطبيق</h4>
          </div>
          <div className="col-md-3 text-center">
            <Image src={layer2} width={300} height={400} alt="phone-download" />
            <h4 className="  py-3 phoneusepra"> اختر الوجهة والباقة </h4>
          </div>
          <div className="col-md-3 text-center">
            <Image src={layer3} width={300} height={400} alt="phone-download" />
            <h4 className="  py-3 phoneusepra"> ثبت الشريحة</h4>
          </div>
          <div className="col-md-3 text-center">
            <Image src={layer4} width={300} height={400} alt="phone-download" />
